     ...
     return (
       ...
       <View key={index}>
       {
         dateItem.events.map((eventItem, index1)=>{
           ...
           <View key={index1}>
           {
           ((_isSubscribed(data.subTeams, eventItem.team1key)=== true) || (_isSubscribed(data.subTeams, eventItem.team2key)=== true)) &&
...
export default ScheduleMyCards;
